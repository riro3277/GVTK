...
class GVTKCollision(GVTKProblem):
    ...
    def runCompute(self):
        ...
        meshFile    = '/Volumes/easystore/New-LVAD-dataset-Post-processed-files/Case-ID-10-ConstantVAD-3rdcycle-post/Case-10-MR-test/clipped-volume-mesh-wSDF-igl.vtu'
        surfaceFile = '/Volumes/easystore/New-LVAD-dataset-Post-processed-files/Case-ID-10-ConstantVAD-3rdcycle-post/Case-10-MR-test/clipped-Case-ID-10-surface.stl'
        outFile     = '/Volumes/easystore/New-LVAD-dataset-Post-processed-files/Case-ID-10-ConstantVAD-3rdcycle-post/Case-10-MR-test/MR-Case-ID-10-sdf-grad.vtu'
    ...
    def sdfCollision(self, simTime, tWin_0, tWin_1, gradVel, boundaryCondition, a_Locator, a_DataSync=True, a_PolygonalCells=False):
        ...
        c_3 = 0.4251
        c_4 = 6880.95
        d_1 = (3.0 * self.m_InputData.getFluidDensity())/(8.0 * self.m_I/nputData.m_TracerRadius)
        C_am    = 1.0
        accGrav = -9.80665 * 1000.0 # -9806.65 mm/sec^2
